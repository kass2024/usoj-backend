            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ route('student.dashboard') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="/images/usj-crest.png" alt="" height="40">
                        </span>
                        <span class="logo-lg">
                            <img src="/images/usj-crest.png" alt="" height="40">
                        </span>
...
<img class="rounded-circle header-profile-user"
     ...
     alt="Profile Photo">
                            ...
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::guard('student')->user()->fname }}
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome {{ Auth::guard('student')->user()->fname }}!</h6>
