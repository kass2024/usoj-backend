                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex flex-wrap align-items-start gap-2">
                                ...
                                <a href="{{ route('lecture.quiz.create', $quiz->id) }}" type="button"
        ...
        @foreach ($questions as $question)
            <div class="card mb-3">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <!-- Edit Button -->
                        <a href="{{ route('lecture.quiz.edit', $question->id) }}" class="btn btn-sm btn-warning">
                            <i class="ri-edit-line"></i> Edit
                        </a>

                        <!-- Delete Button -->
                        <form action="{{ route('lecture.quiz.delete_question', $question->id) }}" method="POST"
