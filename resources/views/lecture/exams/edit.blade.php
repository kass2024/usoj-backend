    ...
    <div class="row">
        <div class="col-md-10">
            <div class="card" id="List">
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex flex-wrap align-items-start gap-2">
                                <a href="{{ route('lecture.exam.questions', $question->exam_id) }}" type="button" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form method="POST" class="row g-3" action="{{ route('lecture.exam.update_question', $question->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6">
