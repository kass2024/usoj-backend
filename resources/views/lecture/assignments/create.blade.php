    ...
    <div class="row">
        <div class="col-md-10">
            <div class="card" id="List">
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex flex-wrap align-items-start gap-2">
                                <a href="{{ route('lecture.assignment.questions', $id) }}" type="button" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form method="POST" class="row g-3" action="{{ route('lecture.assignment.store_question', $id) }}"
                        >
                        @csrf
                        <div class="col-md-6">
                            ...
                            <select name="type" id="question-type" class="form-select" required>
                                ...
                                <option value="radio" {{ old('type') == 'radio' ? 'selected' : '' }}>Single Choice
                                    (Radio)
                                </option>
                                <option value="checkbox" {{ old('type') == 'checkbox' ? 'selected' : '' }}>Multiple
                                    Choice
                                    (Checkbox)</option>
                                <option value="open" {{ old('type') == 'open' ? 'selected' : '' }}>Open Question
                                </option>
                        ...
                        <div id="choices-container" class="col-md-12 mb-2" style="display: none;">
                            <div class="row mb-2 g-3">

                                <table id="item_table" style="width: 100%">
                                    @php
                                        $oldChoices = old('choices', [1 => '']);
                                        ...
                                        <tr>
                                            <td>
                                                <div class="row mb-2 g-3">
                                                    ...
                                                    <div class="col-10">
                                                        <input name="choices[{{ $key }}]" type="text" required
