                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex flex-wrap align-items-start gap-2">
                                <button data-bs-toggle="modal" data-bs-target="#showModal" id="create-btn"
                                    data-action="{{ route('hod.modules.store', $class_year->id) }}"
                                    class="btn btn-primary add-btn">
                                    <i class="ri-add-line align-bottom me-1"></i> Add Module
                                </button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            {{-- <li class="list-inline-item edit" data-bs-toggle="tooltip"
                                                ...
                                                <a href="#showModal" data-bs-toggle="modal" data-id="{{ $item->id }}"
                                                    ...
                                                    data-action="{{ route('hod.modules.update', $item->id) }}"
                ...
                <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form method="POST" class="modal-form" autocomplete="off">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="semester" id="semester">
                                            @for ($i = 0; $i < $class_year->semester; $i++)
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '#create-btn', function() {
                document.getElementById("exampleModalLabel").innerHTML = "Add Module";
            ...
            $(document).on('click', '.remove-item-btn', function() {
                var route = "{{ route('hod.modules.destroy', ['id' => ':id']) }}";
    ...
    @if ($errors->any())
        @if (old('id'))
            <script>
                document.getElementById("add-btn").innerHTML = "Save Changes";
                document.getElementById("exampleModalLabel").innerHTML = "Edit Module";
                ...
                var id = "{{ old('id') }}";
                var route = "{{ route('hod.modules.update', ['id' => ':id']) }}";
