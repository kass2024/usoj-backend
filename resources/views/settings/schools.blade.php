                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex flex-wrap align-items-start gap-2">
                                ...
                                <button type="button" class="btn btn-primary add-btn"
                                    data-action="{{ route('settings.schools.store') }}" data-bs-toggle="modal"
                        ...
                        <tbody class="list" id="table-list">
                            @foreach ($schools as $school)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $school->status == 'active' ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger' }}">{{ ucfirst($school->status) }}</span>
                                    </td>
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item edit" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                <a href="#showModal" data-bs-toggle="modal" data-id="{{ $school->id }}"
                                                    data-name="{{ $school->name }}" data-status="{{ $school->status }}"
                                                    data-program_id="{{ $school->program_id }}"
                                                    data-description="{{ $school->description }}"
                                                    data-action="{{ route('settings.schools.update', ['school' => $school->id]) }}"
