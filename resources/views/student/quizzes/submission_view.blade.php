...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h5>Quiz Submission Details</h5>
        </div>
        <div class="card-body">
            @foreach ($submission->answers as $answerData)
                @php
                    $question = $submission->quiz->questions->firstWhere('id', $answerData['question_id']);
                @endphp
                <div class="card mb-3">
                    <div class="card-body">
            ...
            <div class="card">
                <div class="card-body">
                    <h5>Total Marks: {{ $submission->marks_obtained }} / {{ $totalQuizMarks }}</h5>
                </div>
            </div>
    </div>
</div>
