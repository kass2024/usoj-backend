...
class ExamController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return back()->with('message', 'Exam update successfully.');
        } catch (\Throwable $th) {
            return back()->with('error', $th->getMessage());
        }
    }
    ...
    public function questions($id)
    {
        ...
        return view('lecture.exams.questions', compact('exam', 'questions'));
    }
    public function create($id)
    {
        return view('lecture.exams.create', compact('id'));
    }
    public function edit($id)
    {
        $question = Question::findOrFail($id);
        return view('lecture.exams.edit', compact('question'));
    }


    public function store_question(Request $request, $exam_id)
    {
