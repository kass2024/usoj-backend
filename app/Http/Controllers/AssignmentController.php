...
class AssignmentController extends Controller
{
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            return back()->with('message', 'Assignment created successfully.');
        } catch (\Throwable $th) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            Assignment::findOrFail($id)->update($request->all());
            return back()->with('message', 'Assignment update successfully.');
        } catch (\Throwable $th) {
            return back()->with('error', $th->getMessage());
        }
    }
    public function delete($id)
    {
        try {
            ...
            return back()->with('message', 'Assignment deleted successfully.');
        } catch (\Throwable $th) {
            return back()->with('error', $th->getMessage());
        }
    }
    public function questions($id)
    {
        ...
        return view('lecture.assignments.questions', compact('assignment', 'questions'));
    }
    public function create($id)
    {
        return view('lecture.assignments.create', compact('id'));
    }
    public function edit($id)
    {
        $question = Question::findOrFail($id);
        return view('lecture.assignments.edit', compact('question'));
    }

    public function store_question(Request $request, $assignment_id)
    {
